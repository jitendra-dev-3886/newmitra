									...
									<table class="table text-md-nowrap text-center" id="example1">
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td align="center">
                                                    <a href="<?php echo base_url();?>master/update-bank-details/<?php echo $v->bank_id ?>" class="text-info" title="edit"><i class="fa fa-edit"></i></a>
                                                    &nbsp;&nbsp;
                                                    <a href="<?php echo base_url();?>master/delete-bank-details/<?php echo $v->bank_id ?>" onclick="return confirm('Are you sure?')" class="text-danger" title="edit"><i class="fa fa-trash"></i></a>                                             
                                                </td>                                                                   
                                            </tr>
                                      <?php $sl++;} } ?>
										</tbody>
            		...
            		<div class="modal" id="modaldemo7">
            			<div class="modal-dialog modal-dialog-centered" role="document">
            				<div class="modal-content modal-content-demo">
            					...
            					<form action="<?php echo site_url('master/add-bank-details'); ?>" data-parsley-validate="" method="post">
