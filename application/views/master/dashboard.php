										...
										<div class="project-content">
											...
											<ul>
												<li>
													...
													<span><?php if(!empty($data['success'][0]->total)){echo $data['success'][0]->total; }else{ echo '0'; }?>/-</span>
												</li>
                                            </ul>
										</div>
									</div>
    					...
    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								...
    								<h3 class="font-weight-semibold">₹ <?php echo round($data['distBal'][0]->totalBal+$data['masBal'][0]->totalBal+$data['retBal'][0]->totalBal+$data['apiBal'][0]->totalBal,2); ?></h3>
    							</div>
    						</div>
    					</div>
    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								...
    								<h6 class="mb-1 text-muted">AEPS Balance</h6>
    								<h3 class="font-weight-semibold">₹ <?php echo round($data['aepsBal'][0]->totalBal) ?></h3>
    							</div>
    						</div>
    					</div>
    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
							...
							<div class="card">
										...
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													...
													<h3 class="mb-0">₹ <?php if(!empty($data['fundReq'][0]->amt)){echo $data['fundReq'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Pending Requests</p>
													<h3 class="mb-0"><?php if(!empty($data['pendingFundReq'][0]->cnt)){echo $data['pendingFundReq'][0]->cnt; }else{ echo '0'; }?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										...
										<span class="float-right ml-auto">₹ <?php if(!empty($data['rejectedFundReq'][0]->amt)){echo $data['rejectedFundReq'][0]->amt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Rejected Requests</div>
										</div>
										<span class="float-right ml-auto">₹ <?php if(!empty($data['successFundReq'][0]->amt)){echo $data['successFundReq'][0]->amt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										...
										<span class="float-right ml-auto">₹ <?php if(!empty($data['pendingFundReq'][0]->amt)){echo $data['pendingFundReq'][0]->amt; }else{ echo '0'; }?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card">
										...
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													...
													<h3 class="mb-0">₹ <?php if(!empty($pending = $data['pendding'][0]->amt)){$data['pendding'][0]->amt;}else{ $pending = 0; }
													if(!empty($success = $data['success'][0]->amt)){$data['success'][0]->amt;}else{ $success = 0; }
													if(!empty($failed = $data['failed'][0]->amt)){$data['failed'][0]->amt;}else{ $failed = 0; }
											...
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													...
													<h3 class="mb-0">₹ <?php if(!empty($data['pending'][0]->amt)){echo $data['pending'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										...
										<span class="float-right ml-auto"><?php if(!empty($data['success'][0]->cnt)){echo $data['success'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Failed Recharges</div>
										</div>
										<span class="float-right ml-auto"><?php if(!empty($data['failed'][0]->cnt)){echo $data['failed'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Pending Recharges</div>
										</div>
										<span class="float-right ml-auto"><?php if(!empty($data['pending'][0]->cnt)){echo $data['pending'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card">
										...
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													...
													<!--<h3 class="mb-0">₹ <?php if(!empty($data['ticketAmount'][0]->amt)){echo $data['ticketAmount'][0]->amt; }else{ echo '0'; }?></h3>
												--></div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Open Tickets</p>
												<!--	<h3 class="mb-0">₹ <?php if(!empty($data['pendingTicketAmount'][0]->amt)){echo $data['pendingTicketAmount'][0]->amt; }else{ echo '0'; }?></h3>
												--></div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										...
										<span class="float-right ml-auto"><?php echo count($data['penTickets']); ?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Closed Tickets</div>
										</div>
										<span class="float-right ml-auto"><?php echo count($data['closeTickets']); ?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Total Tickets</div>
										</div>
										<span class="float-right ml-auto"><?php echo count($data['penTickets'])+count($data['closeTickets']); ?></span>
									</div>
								</div>-->
							</div>
						</div>
