									...
									<table class="table text-md-nowrap text-center" id="example1">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-primary"><a href="<?php echo base_url(); ?>master/delete-news/<?php echo $news->news_id; ?>" onclick="return confirm('Delete News Id <?php echo ucfirst($i); ?> ? ')" ><b><i class="typcn typcn-delete-outline tx-24 lh--9 op-6"></i></b></a></td>
											</tr>
											<?php }} ?>
										</tbody>
									</table>
            		...
            		<div class="modal" id="modaldemo7">
            			<div class="modal-dialog modal-dialog-centered" role="document">
            				<div class="modal-content modal-content-demo">
            					...
            					<form action="<?php echo site_url('master/add_news'); ?>" data-parsley-validate="" method="post">
