...
<html lang="en">
					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<p class="mg-b-20">Create new Distributor (Available Credits Is :<?php print_r($credits);?>).</p>
								<form action="<?php echo site_url('master/add-member-succ'); ?>" method="post">
									<div class="row row-sm">
									    ...
									    <span class="col-6" id="members"></span>
	...
	<script>
	    ...
	    var getMembers = cus_type =>{
	        ...
	        $.ajax({
	            type: "post",
	            url: "<?php echo base_url() ?>master/getUplineMembers",
	            cache: "false",
	    ...
	    var getMemberPackage = cus_type =>{
	        ...
	        $.ajax({
	            type: "post",
	            url: "<?php echo base_url()?>master/getMemberPackage",
	            cache: false,
	            data: {cus_type:cus_type},
	            success: function(res){
	                $("#package").empty();
