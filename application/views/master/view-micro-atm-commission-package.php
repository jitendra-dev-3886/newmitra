									...
									<table class="table text-md-nowrap text-center" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-20p border-bottom-0">Pakage Updated Date</th>
											</tr>
										</thead>
										<tbody>
											...
											<!--	<td class="text-primary"><a href="<?php echo base_url(); ?>master/aeps-delete-package/<?php echo $pack->aeps_comm_id; ?>" onclick="return confirm('Delete Package <?php echo ucfirst($pack->package_name); ?> ? ')" ><b><i class="typcn typcn-delete-outline tx-24 lh--9 op-6"></i></b></a></td>
											--></tr>
											<?php }} ?>
										</tbody>
									</table>
            		...
            		<div class="modal" id="modaldemo7">
            			<div class="modal-dialog modal-dialog-centered" role="document">
            				<div class="modal-content modal-content-demo">
            					...
            					<form action="<?php echo site_url('master/micro-atm-package-add'); ?>" data-parsley-validate="" method="post">
    									    ...
    									    <div class="col-12">
    									        <div class="form-group">
    												...
    												<div class="input-group">
        												...
        												<input class="form-control" placeholder="Commission in Percent" type="number" required name="commission">
        											</div>
    											</div>
    									    </div>
    									    <div class="col-12">
