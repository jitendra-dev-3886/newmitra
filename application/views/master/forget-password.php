                            ...
                            <form method="POST" action="">
                                <div class="form-group"> 
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">                                              
                                        <input type="text" id="username" maxlength="10" minlength="10" onkeypress="return/[0-9]/i.test(event.key)" class="form-control" name="username" placeholder="Enter Registered Mobile Number" required="required">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">  
                                        <div class="fxt-checkbox-area">
                                            <div class="checkbox">
                                                <a href="<?php echo base_url() ?>" class="switcher-text">Back To Home</a>
                                            </div>
                                            <a href="<?php echo site_url('admin_login/form_login') ?>" class="switcher-text">Sign In Here</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-4">  
                                        <button type="submit" class="fxt-btn-fill">Click Here to Reset Password</button>
                                    </div>
                                </div>
                            </form>                
                        </div> 
