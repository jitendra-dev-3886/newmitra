							...
							<div class="card-body">
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										...
    										<form action="<?php echo site_url('api_partner/search_aeps_report'); ?>" method="post">
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
										    <?php if(is_array($aepsReport)){$i=0;foreach($aepsReport as $rec){ ?>
    											<tr>
