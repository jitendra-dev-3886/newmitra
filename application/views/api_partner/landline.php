					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Landline Recharge</li>
							</ol>
						</nav>
					</div>
                        						...
                        						<div class="row">	
                        						    <div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                            							    <label class="main-content-label tx-11 tx-medium tx-gray-600">Enter Landline Number</label> 
                            							    <input class="form-control" id="prepaid_mobile" required="" name="number" placeholder="Mobile Number" type="text">
                                    						<input class="form-control" required="" type="hidden" name="type" value="landline">
                                    						<input class="form-control" required="" type="hidden" name="redirect" value="landline">
                            						    </div>
                        							</div>
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                        								<div class="form-group">
                        									...
                        									<select class="form-control select2-no-search" name="operator" required="">
                        										...
                        										<?php if($operator){foreach($operator as $op){ if($op->opsertype=='landline'){?>
