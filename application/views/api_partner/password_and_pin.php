								...
								<div class="row">
									<div class="col-md-6 col-lg-6 col-xl-6 mx-auto d-block">
                        			    <div class="card card-body pd-20 pd-md-40 border shadow-none">
                        					<form action="<?php echo base_url();?>api_partner/password_and_pin" method="post" enctype="multipart/form-data">
                        					   	<div class="row">	
	...
	<script>
        $(document).ready(function(){
          $("#old_password").focusout(function(){
            ...
            $.ajax({
      		        url: "<?php echo site_url();?>/api_partner/check_password",
          		    async: false,
          		    type: "POST",
        ...
        $(document).ready(function(){
          $("#old_pin").focusout(function(){
            ...
            $.ajax({
      		        url: "<?php echo site_url();?>/api_partner/check_pin",
          		    async: false,
          		    type: "POST",
