					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Adhar Pay Report</li>
							</ol>
						</nav>
					</div>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-2 mt-2">Adhar Pay Report</h4>
							    ...
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('api_partner/search_adhar_pay_report'); ?>" method="post">
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
												...
												<th class="wd-5p border-bottom-0">Txn Id</th>
												...
												<th class="wd-10p border-bottom-0">Remark</th>
												<th class="wd-10p border-bottom-0">Print</th>
												
											</tr>
										</thead>
										<tbody>
										    <?php if(is_array($adhar_pay_report)){$i=0;foreach($adhar_pay_report as $rec){ ?>
    											<tr>
    											    <td><?php echo ++$i;?></td>
    												...
    												<td><b><?php echo $rec->api_partner_commission;?></b></td>
    												...
    												<td>
    												 ...
    												 <td>
    												    <a href="https://edigitalvillage.net/api_partner/cashwithdrawalaeps_print/<?php echo $rec->aeps_id;?>" class="btn btn-main-primary btn-block nextBtn">Print</a>
    												</td>  
