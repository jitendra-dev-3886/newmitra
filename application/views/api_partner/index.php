			...
			<div class="main-signin-wrapper" style="padding: 0px 20px;">
				...
				<div class="p-5 wd-md-50p" style="width: 35% !important;padding: 15px 3rem !important;">
					<div class="main-signin-header">
						<img src="<?php base_url();?>/assets/logo.png?<?php echo rand(00000,99999); ?>" alt="Logo" style="padding-left: 20%;width: 60%;">
						<form action="<?php base_url();?>login" method="post">
						    <div class="form-group">
								...
								<select class="form-control" name="user_type" required="required">
                                    ...
                                    <option value="api" selected>API Client</option>
                                </select>
							</div>
							<div class="form-group">
								<label>Username</label><input class="form-control" placeholder="Enter your mobile" type="text" name="mobile" required="required">
								<input type="hidden" id="lat" class="form-control" name="location">
							</div>
							<div class="form-group">
								<label>Password</label> <input class="form-control" placeholder="Enter your password" type="password" name="password" required="required">
							</div>
