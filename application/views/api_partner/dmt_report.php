							    ...
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('api_partner/search_dmt_report'); ?>" method="post">
...
<!--    											<div class="col-md-3 col-lg-3 col-xl-3">
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
										   <?php $credit_bal=0; if($dmt_txn){$i=0;foreach($dmt_txn as $res){ ?>
											<tr>
											    <td><?php echo ++$i;?></td>
												<td><b><?php echo $res->trans_id?></b></td>
												...
												<td> <?php echo $res->dmt_trnx_date;?></td>
												     ...
												     <td style="color:yellow">Pending<br></td>
