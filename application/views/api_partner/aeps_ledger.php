					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Aeps Ledger</li>
							</ol>
						</nav>
					</div>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-2 mt-2">Aeps Ledger</h4>
							...
							<div class="card-body">
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('api_partner/search_aeps_ledger'); ?>" method="post">
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
										   <?php $credit_bal=0; if($aeps_ledger){foreach($aeps_ledger as $rec){ ?>
											<tr>
											    <td><?php echo ++$i;?></td>
												<td><b><?php echo $rec->aeps_txn_id?></b></td>
												<td><?php echo $rec->aeps_txn_date?></td>
												<td>₹ <?php echo $rec->aeps_txn_opbal?></td>
												<td>₹ <?php echo $rec->aeps_txn_crdt?></td>
												<td>₹ <?php echo $rec->aeps_txn_dbdt?></td>
												<td>₹ <?php echo $rec->aeps_txn_clbal?></td>
												<td><?php echo $rec->aeps_txn_type?></td>
