					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Pan Report</li>
							</ol>
						</nav>
					</div>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-2 mt-2">Pan Report</h4>
							...
							<div class="card-body">
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('api_partner/search_pan_report'); ?>" method="post">
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
										    <?php if(is_array($coupons)){$i=0;foreach($coupons as $rec){ ?>
    											<tr>
    											    <td><?php echo ++$i;?></td>
    												...
    												<td><?php echo $rec->coupon_price; ?></b></td>
    												...
    												<td>
    												 ...
    												 <?php   } ?>
    												<td><a href="<?php echo base_url()?>api_partner/pan_cardreceipt/<?php echo $rec->coupon_buy_id;?> "><i class="fa fa-print" class="btn-main-primary"></i></a></td>
    											</tr>
											<?php }} ?>
										</tbody>
									</table>
