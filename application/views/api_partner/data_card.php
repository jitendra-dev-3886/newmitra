					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Data Card Recharge</li>
							</ol>
						</nav>
					</div>
                        				    ...
                        				    <form action="<?php echo base_url();?>/Retailer/recharge_ot" method="post">
                        						<div class="row">	
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                        							    <div class="form-group">
                        									<label class="main-content-label tx-11 tx-medium tx-gray-600">Enter Data Card Number</label> 
                        									<input class="form-control" required="" name="number" placeholder="Data Card Number" type="text" minlength="10" maxlength="10">
                        									<input class="form-control" required="" type="hidden" name="type" value="datacard">
                        									<input class="form-control" required="" type="hidden" name="redirect" value="data_card">
                        								</div>
                        							</div>
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                        								<div class="form-group">
                        									...
                        									<select class="form-control select2-no-search" name="operator" required="">
                        										...
                        										<?php if($operator){foreach($operator as $op){ if($op->opsertype=='datacard'){?>
                        						...
                        						<div class="form-group">
                        							...
                        							<div class="pos-relative">
                        								<input class="form-control pd-r-80" required="" name="amount" type="number" placeholder="Amount">
                        							</div>
                        						</div>
