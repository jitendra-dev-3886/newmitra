                        		        ...
                        		        <div class="card card-body pd-20 pd-md-40 border shadow-none">
                        					<form action="<?php echo base_url();?>/Retailer/recharge_ot" method="post">
                        						<div class="row">
                        							...
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                            								<label class="main-content-label tx-11 tx-medium tx-gray-600">Consumer Id / Account No</label> 
                            								<input class="form-control" id="prepaid_mobile" required="" name="number" placeholder="Consumer Id / Account No" type="text">
