								...
								<div class="row">
									                           <div class="col-md-10 col-lg-10 col-xl-10 mx-auto d-block">
                        										<div class="card card-body pd-20 pd-md-40 border shadow-none">
                        										    <form action="<?php echo base_url();?>Retailer/send_ticket" method="post" enctype="multipart/form-data">
                        										    ...
                        										    <div class="row">	
                            										    <div class="col-md-6 col-lg-6 col-xl-6">
                                											<div class="form-group">
                                												...
                                												<textarea class="form-control" required="" name="desc" placeholder="Tell Me More" rows="9"></textarea>
                                											</div>
                            											</div>
                            										    <div class="col-md-6 col-lg-6 col-xl-6">
                                											<div class="form-group">
                        											...
                        											<input type="hidden" id="tick" name="ticket" value="<?php echo $ticket[0]->ticket_id; ?>">
