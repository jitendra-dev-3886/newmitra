						...
						<div class="card">
							<div class="card-header pb-0">
								...
								<div class="d-flex justify-content-between">
									<div class="col-sm-6 col-md-3"><button class="modal-effect btn btn-main-primary btn-block btn-rounded "  data-effect="effect-slide-in-right" data-toggle="modal" href="#modaldemo7">Add New Package</button></div>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap text-center" id="example1">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-success"><a href="<?php echo base_url(); ?>distributor/view_package_commission/<?php echo $pack->package_id; ?>"><b><i class="typcn typcn-eye-outline tx-24 lh--9 op-6"></i></b></a></td>
												<td class="text-primary"><a href="<?php echo base_url(); ?>distributor/delete_package/<?php echo $pack->package_id; ?>" onclick="return confirm('Delete Package <?php echo ucfirst($pack->package_name); ?> ? ')" ><b><i class="typcn typcn-delete-outline tx-24 lh--9 op-6"></i></b></a></td>
											</tr>
											<?php }} ?>
										</tbody>
									</table>
            		...
            		<div class="modal" id="modaldemo7">
            			<div class="modal-dialog modal-dialog-centered" role="document">
            				<div class="modal-content modal-content-demo">
            					...
            					<form action="<?php echo base_url();?>distributor/package_add" method="post">
									    ...
									    <div class="col-12">
									        <div class="form-group">
												...
												<div class="input-group">
            										...
            										<input class="form-control" required="" name="package_name" placeholder="Enter Package name more then 2 character:" type="text">
    											</div>
											</div>
									    </div>
            					...
            					<div class="modal-footer">
            						<button class="btn ripple btn-primary" type="submit" value="Add Package" type="button">Add</button>
