		...
		<div class="main-content horizontal-content">
			...
			<div class="container">
				...
				<div class="breadcrumb-header justify-content-between">
					<div>
						<h4 class="content-title mb-2">Account</h4>
								...
								<div class="row">
									<div class="col-md-6 col-lg-6 col-xl-6 mx-auto d-block">
                        			    <div class="card card-body pd-20 pd-md-40 border shadow-none">
                        					<form action="<?php echo base_url();?>distributor/password_and_pin" method="post" enctype="multipart/form-data">
                        					   	<div class="row">	
	...
	<script>
        $(document).ready(function(){
          $("#old_password").focusout(function(){
            ...
            $.ajax({
      		        url: "<?php echo site_url();?>distributor/check_password",
          		    async: false,
          		    type: "POST",
