        								...
        								<div class="box box-primary">
            							  ...
            							  <table width="99%" border="1" class="table table-bordered">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                <?php                    
                                                echo form_open('admin/movedistributor');
                                                ?>
                                                <div class="row">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                <?php                    
                                                echo form_open('admin/moveretailer');
                                                ?>
                                                <div class="row">
                                                  <div class="col-md-8 col-sm-12">
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                <?php                    
                                                echo form_open('admin/movemaster');
                                                ?>
                                                <div class="row">
                                                  <div class="col-md-8 col-sm-12">
                                              ...
                                              <tr>
                                                ...
                                                {
                                                  echo "<a href='".base_url().'admin/in-active-customer/'.$r['info']->cus_id."' class='btn btn-success btn-flat' >Active</a>";  
                                                }
                                                else
                                                {
                                                  echo "<a href='".base_url().'admin/active-customer/'.$r['info']->cus_id."' class='btn btn-danger btn-flat' >In Active</a>";
                                                }
                                                ?></td>
                                              </tr>
