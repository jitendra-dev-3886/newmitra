						...
						<div class="card">
							<div class="card-body">
								...
								<form action="<?php echo site_url('admin/switch-success'); ?>" method="post">
                                    ...
                                    <a href="<?php echo base_url();?>admin/view-all-members"><button type="button" class="btn btn-danger pull-right" data-dismiss="modal"><i class="fa fa-times"></i> Discard</button></a>
