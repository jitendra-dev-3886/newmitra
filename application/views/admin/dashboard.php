			...
			<div class="container">
				...
				<div class="breadcrumb-header justify-content-between">
					<div>
						...
						<!--<?php echo $this->encryption_model->decode('2dec9e43a09224235c7572d3f262e036');?>-->
									...
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<ul>
												<li>
													<strong>Rupees</strong>
													<span><?php if(!empty($data['pending'][0]->amt)){echo $data['pending'][0]->amt; }else{ echo '0'; }?>/-</span>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<ul>
												<li>
													<strong>Rupees</strong>
													<span><?php if(!empty($data['fundReq'][0]->amt)){echo $data['fundReq'][0]->amt; }else{ echo '0'; }?>/-</span>
												</li>
											</ul>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-md-12 col-12 text-center">
							<div class="task-box danger mb-0">
								<h5 class="mb-0" style="text-align:left;"><i class="fe fe-user"></i>  Members</h5>
							</div>
						</div>
					</div>
					<br>
    				...
    				<div class="row row-sm">
    						...
    						<div class="card">
    							<div class="card-body iconfont text-left">
    								<div class="d-flex justify-content-between">
    									<h4 class="card-title mb-3">Retailers</h4>
    									<i class="mdi mdi-dots-vertical"></i>
    								</div>
    								<div class="d-flex mb-0">
    									<div class="">
    										<h4 class="mb-1 font-weight-bold"><?php if(!empty($data['retCnt'][0]->cnt)){echo $data['retCnt'][0]->cnt; }else{ echo '0'; }?><span class="text-primary tx-13 ml-2">(₹<?php if(!empty($data['retBal'][0]->totalBal)){echo round($data['retBal'][0]->totalBal,2); }else{ echo '0'; }?>)</span></h4>
    									</div>
    					...
    					<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
    						<div class="card">
    							<div class="card-body iconfont text-left">
    								<div class="d-flex justify-content-between">
    									<h4 class="card-title mb-3">Distributors</h4>
    									<i class="mdi mdi-dots-vertical"></i>
    								</div>
    								<div class="d-flex mb-0">
    									<div class="">
    										<h4 class="mb-1 font-weight-bold"><?php if(!empty($data['distCnt'][0]->cnt)){echo $data['distCnt'][0]->cnt; }else{ echo '0'; }?><span class="text-danger tx-13 ml-2">(₹<?php if(!empty($data['distBal'][0]->totalBal)){echo round($data['distBal'][0]->totalBal,2); }else{ echo '0'; }?>)</span></h4>
    									</div>
    					...
    					<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
    						<div class="card">
    							<div class="card-body iconfont text-left">
    								<div class="d-flex justify-content-between">
    									<h4 class="card-title mb-3">Masters</h4>
    									<i class="mdi mdi-dots-vertical"></i>
    								</div>
    								<div class="d-flex mb-0">
    									<div class="">
    										<h4 class="mb-1   font-weight-bold"><?php if(!empty($data['masCnt'][0]->cnt)){echo $data['masCnt'][0]->cnt; }else{ echo '0'; }?><span class="text-info tx-13 ml-2">(₹<?php if(!empty($data['masBal'][0]->totalBal)){echo round($data['masBal'][0]->totalBal,2); }else{ echo '0'; }?>)</span></h4>
    									</div>
    					...
    					<div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
    						<div class="card">
    							<div class="card-body iconfont text-left">
    								<div class="d-flex justify-content-between">
    									<h4 class="card-title mb-3">API Clients </h4>
    									<i class="mdi mdi-dots-vertical"></i>
    								</div>
    								<div class="d-flex mb-0">
    									<div class="">
    										<h4 class="mb-1 font-weight-bold"><?php if(!empty($data['apiCnt'][0]->cnt)){echo $data['apiCnt'][0]->cnt; }else{ echo '0'; }?><span class="text-purple tx-13 ml-2">(₹<?php if(!empty($data['apiBal'][0]->totalBal)){echo round($data['apiBal'][0]->totalBal,2); }else{ echo '0'; }?>)</span></h4>
    									</div>
    					...
    					<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
    						<div class="card">
    							<div class="card-body iconfont text-left">
    								<div class="d-flex justify-content-between">
    									<h4 class="card-title mb-3">Total Balance </h4>
    									<i class="mdi mdi-dots-vertical"></i>
    								</div>
    								<div class="d-flex mb-0">
    									<div class="">
    										<h4 class="mb-1 font-weight-bold">    				₹ <?php echo round($data['distBal'][0]->totalBal+$data['masBal'][0]->totalBal+$data['retBal'][0]->totalBal+$data['apiBal'][0]->totalBal,2); ?></h4>
    									</div>
    									<div class="card-chart bg-warning-transparent brround ml-auto mt-0">
    										<i class="typcn typcn-credit-card  text-warning tx-24"></i>
    									</div>
    								</div>
    
    								<div class="progress progress-sm mt-2">
    									<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70" class="progress-bar bg-warning wd-100p" role="progressbar"></div>
    								</div>
    							</div>
    						</div>
    					</div>
    						...
    						<div class="card text-center">
    							<div class="card-body ">
    								<div class="feature widget-2 text-center mt-0 mb-3">
    									<i class="ti-pulse  project bg-warning-transparent mx-auto text-warning " style="width:30px;height:30px;"></i>
    								</div>
    								<h6 class="mb-1 text-muted">BBPS</h6>
    								<h3 class="font-weight-semibold">₹ 0</h3>
    							</div>
    						</div>
    					</div>
    				<!--	<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								...
    								<h3 class="font-weight-semibold">₹ <?php echo $data['aepsCashWithdrawAmount'][0]->amount+$data['aepsAadharPayAmount'][0]->amount; ?></h3>
    							</div>
    						</div>
    					</div>-->
...
<!--    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body">
    								<div class="feature widget-2 text-center mt-0 mb-3">
    									<img src="../../assets/img/serviceicon/icons8-money-transfer-64.png" style="width:30px;height:30px;"/>
    								</div>
    								<h6 class="mb-1 text-muted">DMT</h6>
    								<h3 class="font-weight-semibold">₹ <?php echo $data['dmtSuccessAmount'][0]->amount + $data['dmtFailedAmount'][0]->amount; ?></h3>
    							</div>
    						</div>
    					</div>-->
    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								...
    								<h6 class="mb-1 text-muted">Total Recharge</h6>
    								<h3 class="font-weight-semibold">₹ <?php echo $data['pending'][0]->amt+$data['success'][0]->amt+$data['failed'][0]->amt; ?></h3>
    							</div>
    						</div>
    					</div>
    				<!--	<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								<div class="feature widget-2 text-center mt-0 mb-3">
    									<img src="https://img.icons8.com/cotton/64/000000/insert-card--v1.png" style="width:30px;height:30px;">
    								</div>
    								<h6 class="mb-1 text-muted">PAN</h6>
    								<h3 class="font-weight-semibold"><?php echo $data['panBuyQuantity'][0]->quantity; ?></h3>
    							</div>
    						</div>
    					</div>-->
    					<div class="col-xl-2 col-lg-6 col-sm-6 col-md-6">
    						<div class="card text-center">
    							<div class="card-body ">
    								...
    								<h6 class="mb-1 text-muted">Tickets</h6>
    								<h3 class="font-weight-semibold"><?php echo count($data['penTickets'])+count($data['closeTickets']); ?></h3>
    							</div>
    						</div>
    					</div>
    				</div>
				...
				<div class="main-content-body">
					...
					<div class="row">
						<div class="col-md-12 col-12 text-center">
							<div class="task-box danger mb-0">
								<h5 class="mb-0" style="text-align:left;"><i class="fe fe-user"></i>  Reports</h5>
							</div>
						</div>
					</div>
					<br>
					...
					<div class="row row-sm">
						<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">Fund Requests</h4>
										...
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Requests</p>
													<h3 class="mb-0">₹ <?php if(!empty($data['fundReqToday'][0]->amt)){echo $data['fundReqToday'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Pending Requests</p>
													<h3 class="mb-0"><?php if(!empty($data['pendingFundReqToday'][0]->cnt)){echo $data['pendingFundReqToday'][0]->cnt; }else{ echo '0'; }?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Accepted Requests</div>
										</div>
										<span class="float-right ml-auto">₹ <?php if(!empty($data['successFundReqToday'][0]->amt)){echo $data['successFundReqToday'][0]->amt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Rejected Requests</div>
										</div>
									    <span class="float-right ml-auto">₹ <?php if(!empty($data['rejectedFundReqToday'][0]->amt)){echo $data['rejectedFundReqToday'][0]->amt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Pending Requests</div>
										</div>
										<span class="float-right ml-auto">₹ <?php if(!empty($data['pendingFundReqToday'][0]->amt)){echo $data['pendingFundReqToday'][0]->amt; }else{ echo '0'; }?></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">Recharge Report</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
								</div>
								<div class="pl-4 pr-4 pt-4 pb-3">
									<div class="">
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Recharges</p>
													<h3 class="mb-0">₹ <?php if(!empty($pending = $data['penddingToday'][0]->amt)){$data['penddingToday'][0]->amt;}else{ $pending = 0; }
													if(!empty($success = $data['successToday'][0]->amt)){$data['successToday'][0]->amt;}else{ $success = 0; }
													if(!empty($failed = $data['failedToday'][0]->amt)){$data['failedToday'][0]->amt;}else{ $failed = 0; }
												echo $pending+$failed+$success;	 ?></h3>
												</div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Pending Recharges</p>
													<h3 class="mb-0">₹ <?php if(!empty($data['penddingToday'][0]->amt)){echo $data['penddingToday'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Success Recharges</div>
										</div>
										<span class="float-right ml-auto"><?php if(!empty($data['successToday'][0]->cnt)){echo $data['successToday'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Failed Recharges</div>
										</div>
										<span class="float-right ml-auto"><?php if(!empty($data['failedToday'][0]->cnt)){echo $data['failedToday'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Pending Recharges</div>
										</div>
										<span class="float-right ml-auto"><?php if(!empty($data['penddingToday'][0]->cnt)){echo $data['penddingToday'][0]->cnt; }else{ echo '0'; }?></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">Support Tickets</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
								</div>
								<div class="pl-4 pr-4 pt-4 pb-3">
									<div class="">
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Tickets</p>
													<h3 class="mb-0">₹ <?php if(!empty($data['ticketAmountToday'][0]->amt)){echo $data['ticketAmountToday'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Open Tickets</p>
													<h3 class="mb-0">₹ <?php if(!empty($data['pendingTicketAmountToday'][0]->amt)){echo $data['pendingTicketAmountToday'][0]->amt; }else{ echo '0'; }?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Open Tickets</div>
										</div>
										<span class="float-right ml-auto"><?php echo count($data['penTicketsToday']); ?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Closed Tickets</div>
										</div>
										<span class="float-right ml-auto"><?php echo count($data['closeTicketsToday']); ?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Total Tickets</div>
										</div>
										<span class="float-right ml-auto"><?php echo count($data['penTicketsToday'])+count($data['closeTicketsToday']); ?></span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row row-sm">
						...
						<!--<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">PAN Report</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
								</div>
								<div class="pl-4 pr-4 pt-4 pb-3">
									<div class="">
										<div class="row">
											<div class="col-md-12 col-12 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Coupans Purchased</p>
													<h3 class="mb-0"><?php echo $data['panBuyQuantityToday'][0]->quantity; ?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Total Buy Amount</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['panBuyAmountToday'][0]->amount; ?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Closing Balance</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['panBuyAmountToday'][0]->balance; ?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Success Coupans</div>
										</div>
										<span class="float-right ml-auto"><?php echo $data['panBuyQuantityToday'][0]->quantity; ?></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">Aeps Report</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
								</div>
								<div class="pl-4 pr-4 pt-4 pb-3">
									<div class="">
										<div class="row">
											<div class="col-md-12 col-12 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Transactions</p>
													<h3 class="mb-0">₹ <?php echo $data['aepsCashWithdrawAmountToday'][0]->amount+$data['aepsAadharPayAmountToday'][0]->amount; ?></h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Cash Withdrawal</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['aepsCashWithdrawAmountToday'][0]->amount; ?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Aadhar Pay</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['aepsAadharPayAmountToday'][0]->amount; ?></span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Pending / Failed </div>
										</div>
										<span class="float-right ml-auto"><?php echo $data['aepsFailedCountToday'][0]->sum; ?></span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 col-lg-6 col-xl-4">
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-10 ">DMT Report</h4>
										<i class="mdi mdi-dots-horizontal text-gray"></i>
									</div>
								</div>
								<div class="pl-4 pr-4 pt-4 pb-3">
									<div class="">
										<div class="row">
											<div class="col-md-12 col-12 text-center">
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Transactions</p>
													<h3 class="mb-0">₹ <?php echo $data['dmtSuccessAmountToday'][0]->amount + $data['dmtFailedAmountToday'][0]->amount; ?></h3>
												</div>
											</div>
								...
								<div class="task-stat pb-0">
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-success mr-2"></i>Success Transactions</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['dmtSuccessAmountToday'][0]->amount; ?></span>
									</div>
									<div class="d-flex tasks">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-pink mr-2"></i>Pending Transactions</div>
										</div>
										<span class="float-right ml-auto">₹ 0</span>
									</div>
									<div class="d-flex tasks mb-0 border-bottom-0">
										<div class="mb-0">
											<div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-purple mr-2"></i>Failed Transactions</div>
										</div>
										<span class="float-right ml-auto">₹ <?php echo $data['dmtFailedAmountToday'][0]->amount; ?></span>
									</div>
								</div>
							</div>
						</div>-->
