...
<html lang="en">
	...
	<body class="main-body  app">
			...
			<div class="container">
				...
				<div class="row row-sm">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
							    <form action="<?php echo base_url();?>admin/redeemRequest" method="post" enctype="multipart/form-data">
									...
									<table class="table text-md-nowrap text-center" id="example1">
										...
										<tbody>
											...
											<tr>
												...
												<i class="fa fa-edit" value="" onclick="succ(<?php echo $rec->pay_req_id;?>)" class="btn btn-main-primary btn-rounded btn-block pull-right" data-target="#modaldemo2" data-toggle="modal"></i>
												
												    <!--<a href="<?php echo base_url();?>admin/redeem_reject/<?php echo $rec->pay_req_id;?>" class="btn btn-main-primary btn-rounded btn-block pull-right" style="color:white;">Reject</a>-->
												<?php }?>
												<?php if($rec->response != ''){ ?>
												<a href="<?php echo base_url()?>admin/transactionEnquiryApi/<?php echo $rec->UNIQUEID;?>"><i class="fa fa-hand-pointer" class="btn"></i></a>
												<?php } ?>
												</td>
											</tr>
											<?php }} ?>
	    ...
	    <div class="modal" id="modaldemo1">
    		<div class="modal-dialog" role="document">
    			<div class="modal-content modal-content-demo">
    				<form action="<?php echo base_url()?>admin/redeem_reject" method="post">
        				<div class="modal-header">
        					<h6 class="modal-title">Reject Redeem</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
        				</div>
    	...
    	<div class="modal" id="modaldemo2">
    		<div class="modal-dialog" role="document">
    			<div class="modal-content modal-content-demo">
    				<form action="<?php echo base_url()?>admin/redeem_success" method="post">
        				<div class="modal-header">
        					<h6 class="modal-title">Success Redeem</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
        				</div>
        				<div class="modal-body">
        					<input type="hidden"  >
            					<div class="form-group">
            					    <label>ID</label>
            					    <input type="text" id="succhere" name="id"class="form-control" readonly required>
            					</div>
            					<div class="form-group">
            					    <label>REFERENCES ID / UTR NO</label>
            					    <textarea class="form-control" name="utr_ref"  required></textarea>
            					</div>
    					</div>
        				<div class="modal-footer">
        					<input class="btn ripple btn-primary" type="submit">
