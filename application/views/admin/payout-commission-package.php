		...
		<div class="main-content horizontal-content">
			...
			<div class="container">
				...
				<div class="breadcrumb-header justify-content-between">
					<div>
						<h4 class="content-title mb-2">Payout Commission Slab Management</h4>
									...
									<table class="table text-md-nowrap text-center" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-15p border-bottom-0">Slab Name</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><b><?php echo ucfirst($pack->datetime); ?></b></td>
												<td class="text-primary"><a href="<?php echo base_url(); ?>admin/payout-delete-package/<?php echo $pack->payout_charge_id; ?>" onclick="return confirm('Delete Package <?php echo ucfirst($pack->slab); ?> ? ')" ><b><i class="typcn typcn-delete-outline tx-24 lh--9 op-6"></i></b></a></td>
											</tr>
											<?php }} ?>
										</tbody>
									</table>
            			...
            			<div class="modal-dialog modal-dialog-centered" role="document">
            				<div class="modal-content modal-content-demo">
            					<div class="modal-header">
            						<h6 class="modal-title">Add New Slab</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            					</div>
            					<form action="<?php echo site_url('admin/payout-package-add'); ?>" data-parsley-validate="" method="post">
                					<div class="modal-body">
        								<div class="row row-sm">
    									    ...
    									    <div class="col-12">
    									        <div class="form-group">
    												<label class="form-label">Slab Name: <span class="tx-danger"></span></label>
    												<div class="input-group">
        												<div class="input-group-prepend">
                											<div class="input-group-text">
                										...
                										<input class="form-control" placeholder="Slab Name" type="text" required name="package_name">
        											</div>
    											</div>
    									    </div>
    									    <div class="col-12">
