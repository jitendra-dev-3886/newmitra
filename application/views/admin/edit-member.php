					...
					<div class="col-lg-12 col-md-12">
						<div class="card">
							<div class="card-body">
								...
								<form action="<?php echo site_url('admin/edit-member-succ'); ?>" method="post">
									<div class="row row-sm">
									        ...
									        <div class="form-group">
												...
												<div class="input-group">
    												...
    												<select class="form-control" name="package_id" id="package">
    												    <?php if($r['info']->scheme_id){
        												        if(is_array($package)){foreach($package as $pack){
        												            if($r['info']->scheme_id == $pack->scheme_id){$packName = $pack->scheme_name;}
        												        }
    												        }
    												    }
    												    if($packName){
    												    ?>
    												    <option value="<?php echo $r['info']->scheme_id ?>"><?php echo $packName; ?></option>
    												    <?php } ?>
    												    <?php if(is_array($package)){foreach($package as $pack){
												         if($r['info']->scheme_id == $pack->scheme_id){
												         }else{ ?>
										...
										<br><br>
										<div class="col-6">
											<label class="form-label">IP Address: <span class="tx-danger">*</span></label>
											<div class="input-group">
												<div class="input-group-prepend">
        											<div class="input-group-text">
        												<i class="typcn typcn-location-outline tx-24 lh--9 op-6"></i>
												...
												<input class="form-control" name="cus_ip" placeholder="Enter IP" value="<?php echo $r['info']->cus_ip; ?>" required="" type="text">
											</div>
										</div>
										
										<div class="col-6">
											<label class="form-label">Limit Amount: <span class="tx-danger">*</span></label>
											<div class="input-group">
												<div class="input-group-prepend">
        											<div class="input-group-text">
        												<i class="typcn typcn-location-outline tx-24 lh--9 op-6"></i>
												...
												<input class="form-control" name="limit_amount" placeholder="enter limit amount" value="<?php echo $r['info']->limit_amount; ?>" required="" type="text">
											</div>
										</div>
