				...
				<div class="row row-sm">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
							    <div class="row">
							        <form action="<?php echo site_url('admin/search-recharge-report'); ?>" method="post">
										...
										<div class="row">	
											...
											<div class="col-md-3"> 
											    <div class="input-group col-md-12"> <div class="input-group-prepend"> <div class="input-group-text"> From </div> </div><input class="form-control fc-datepicker hasDatepicker" placeholder="MM/DD/YYYY" type="date" id="dp1612569947060" name="from_dt"></div>
											</div>
											
											<div class="col-md-3"> 
											    <div class="input-group col-md-12"> <div class="input-group-prepend"> <div class="input-group-text"> To </div> </div><input class="form-control fc-datepicker hasDatepicker" placeholder="MM/DD/YYYY" type="date" id="dp1612569947060" name="to_dt"></div>
											</div>
									...
									<table class="table text-md-nowrap text-center" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-5p border-bottom-0">Rec Id</th>
												...
												<th class="wd-10p border-bottom-0">Retailer</th>
										...
										<tbody>
										    <?php if(is_array($recharges)){$i=0;foreach($recharges as $rec){ ?>
    											<tr>
    											    <td><?php echo ++$i;?></td>
    												<td>
    												    <b><?php echo $rec->recid; ?><br>
    												    <a href="<?php echo site_url('admin/update-recharge-status/'.$rec->recid)?>"><i class="typcn typcn-edit text-success"></i></a>
    												...
    												<td class="text-info"><b>₹ <?php echo $rec->retailer; ?></b></td>
    												<td class="text-info"><b>₹ <?php echo $rec->distributor; ?></b></td>
    												<td class="text-info"><b>₹ <?php echo $rec->master; ?></b></td>
