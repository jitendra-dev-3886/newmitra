			...
			<div class="container">
				...
				<div class="row row-sm">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-body">
							    <form action="<?php echo site_url('admin/virtual-balance-success'); ?>" method="post" accept-charset="utf-8">				
    							    <div class="row">
							    ...
							    <div class="row">
							        <form action="<?php echo site_url('admin/search-vb-report'); ?>" method="post" style="width: 100%;">
											...
											<div class="col-md-3">
    											<div class="form-group">
    												<div class="input-group ">
                										...
                										<input class="form-control fc-datepicker hasDatepicker" id="dp1611913356725" placeholder="MM/DD/YYYY" type="text">
                									</div>
    											</div>
											</div>
