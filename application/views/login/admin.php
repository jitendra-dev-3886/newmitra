				...
				<div class="p-5 wd-md-50p" style="width: 35% !important;padding: 15px 3rem !important;">
					<div class="main-signin-header">
						...
						<form action="" method="post">
							...
							<div class="form-group">
								<label>Register Mobile</label><input class="form-control" placeholder="Enter your mobile" type="text" name="mobile" required="required">
								<input type="hidden" id="lat" class="form-control" name="location">
							</div>
							
							<button class="btn btn-main-primary btn-block" type="submit" name="forget_password">Get OTP</button>
						</form>
					</div>
				</div>
			</div>
