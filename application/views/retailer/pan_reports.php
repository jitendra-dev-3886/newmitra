							    ...
							    <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('Retailer/search_pan_report'); ?>" method="post">
										    ...
										    <?php if(is_array($coupons)){foreach($coupons as $rec){ ?>
    											<tr>
    												...
    												<td>
    												 ...
    												 <?php   } ?>
    												<td><a href="<?php echo base_url()?>retailer/pan_cardreceipt/<?php echo $rec->coupon_buy_id;?> "><i class="fa fa-print" class="btn-main-primary"></i></a></td>
    											</tr>
											<?php }} ?>
										</tbody>
									</table>
