...
.nav-tabs .nav-link + .nav-link {
						...
						<div class="card custom-card" id="tab">
								...
								<div class="row"><br></div>
									<div class="text-wrap">
										<div class="example">
											<div class="border">
											<form role="form" action="<?php echo site_url('retailer/aepsekyc_submit') ?>" method="post" enctype="multipart/form-data">
											    <div class="text-wrap">
											        <div class="example">
												...
												<!--		<a class="nav-link active" data-toggle="tab" href="#tabCont1">EKYC</a>-->
												<!--	</nav>-->
												<!--</div>-->
													...
													<div class="tab-pane active show" id="tabCont1">
													    <div class="row" style="display: contents;">
                                                            <div class="col-md-12 col-lg-12 col-xl-12"><br>
                                                                <h5 class="card-title mg-b-20">EKYC:</h5>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">	
                                    							<div class="col-md-6 col-lg-6 col-xl-6">
                        									        <div class="form-group">
                                        								...
                                        								<input class="form-control" name="aadhaarNumber" value="<?php echo $profile[0]->aeps_aadhaarNumber;?>" minlength="12" maxlength="12" placeholder="Enter Aadhar Number" type="text" readonly>
                                        							</div>
                                    							</div>
                                    							<div class="col-md-6 col-lg-6 col-xl-6">
                        									        <div class="form-group">
                                        								<label class="main-content-label tx-11 tx-medium tx-gray-600 control-label" style="color:red">Pan Number *</label> 
                                        								<input class="form-control" name="userPan" value="<?php echo $profile[0]->aeps_userPan;?>" minlength="12" maxlength="12" placeholder="Enter Pan Number" type="text" readonly>
                                        							</div>
                                    							</div>
                                						    </div>
                                                        	<div class="row">	
                                    							<div class="col-md-12 col-lg-12 col-xl-12">
                                    							    <div class="form-group">
                                    									<label class="main-content-label tx-11 tx-medium tx-gray-600 control-label" style="color:red">Remark *</label>
                                    									<textarea class="form-control" name="requestRemarks" required="required"></textarea>
                                    								</div>
                                    							</div>
                                    						</div>
    ...
    // 		alert(finalUrl);
    	...
    	function CaptureAvdm()
    	{
    	   ...
    	   if($("#txtWadh").val().trim()!="")
    	   {
    		var XML='<?php echo '<?xml version="1.0"?>'; ?> <PidOptions ver="1.0"> <Opts fCount="'+$("#Fcount").val()+'" fType="'+$("#Ftype").val()+'" iCount="'+$("#Icount").val()+'" pCount="'+$("#Pcount").val()+'" format="0"   pidVer="'+$("#Pidver").val()+'" timeout="'+$("#Timeout").val()+'" wadh="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=" posh="UNKNOWN" env="'+$("#Env").val()+'" /> '+DemoFinalString+'<CustOpts><Param name="mantrakey" value="'+$("#txtCK").val()+'" /></CustOpts> </PidOptions>';
    	   }
    	   else
    	   {
    		var XML='<?php echo '<?xml version="1.0"?>'; ?> <PidOptions ver="1.0"> <Opts fCount="'+$("#Fcount").val()+'" fType="'+$("#Ftype").val()+'" iCount="'+$("#Icount").val()+'" pCount="'+$("#Pcount").val()+'" format="0"   pidVer="'+$("#Pidver").val()+'" timeout="'+$("#Timeout").val()+'" wadh="E0jzJ/P8UopUHAieZn8CKqS4WPMi5ZSYXgfnlfkWjrc=" posh="UNKNOWN" env="'+$("#Env").val()+'" /> '+DemoFinalString+'<CustOpts><Param name="mantrakey" value="'+$("#txtCK").val()+'" /></CustOpts> </PidOptions>';
