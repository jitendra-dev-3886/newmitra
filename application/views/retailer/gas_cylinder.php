					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Gas Cylinder</li>
							</ol>
						</nav>
					</div>
								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-10 mx-auto d-block">
                        		        <div class="card card-body pd-20 pd-md-40 border shadow-none">
                        					<form action="<?php echo base_url();?>/Retailer/recharge_ot" method="post" enctype="multipart/form-data">
                        						<div class="row">
                        							...
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                            							    <label class="main-content-label tx-11 tx-medium tx-gray-600">Operators</label>
                            								<select class="form-control select2" name="operator" required="" id="operator">
                        										<option label="Choose one"></option>
                        										<?php if($operator){foreach($operator as $op){ if($op->opsertype=='CYLINDER'){?>
                        							...
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                                    						...
                                    						<input class="form-control" required="" type="hidden" name="type" value="gas">
                                    						<input class="form-control" required="" type="hidden" name="redirect" value="gas_cylinder">
                            							</div>
                        							</div>
                        						</div>
                        						<div class="row">
    ...
    function showplan_new()
          {
            ...
            //   	alert(opcodeid);
                ...
                if($.isNumeric(opcodeid) && prepaid_mobile !== '')
              	{
              		$.ajax({
                  url: '<?php echo base_url(); ?>Retailer/GasInfo',
                  type: 'POST',
                  dataType: 'html',        
                  cache: false,       
