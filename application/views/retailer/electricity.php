                        					...
                        					<form action="<?php echo base_url();?>/Retailer/recharge_ot" method="post">
                        						<div class="row">
                        							...
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                            							    <label class="main-content-label tx-11 tx-medium tx-gray-600">Electricity Board</label>
                            								<select class="form-control select2" name="operator" required="" id="operator">
                        										<option label="Choose one"></option>
                        										<?php if($operator){foreach($operator as $op){ if($op->opsertype=='ELECTRICITY'){?>
                        							...
                        							<div class="col-md-6 col-lg-6 col-xl-6">
                            						    <div class="form-group">
                            								<label class="main-content-label tx-11 tx-medium tx-gray-600">Consumer Id</label> 
                            								<input class="form-control" id="prepaid_mobile" required="" name="number" placeholder="Consumer Id" type="text">
                                    						<input class="form-control" required="" type="hidden" name="type" value="electricity">
                                    						<input class="form-control" required="" type="hidden" name="redirect" value="electricity">
                            							</div>
                        							</div>
                        						</div>
                        						<div class="row">
                        						...
                        						<div class="row">
                        						    <div class="col-md-6 col-lg-6 col-xl-6">
                        						        <div class="form-group">
                            								...
                            								<input class="form-control" id="optional1" required="" name="optional1" placeholder="BU ,city etc." type="text">
                            							</div>
                        						    </div>
                        						    <div class="col-md-6 col-lg-6 col-xl-6">
                        						        <div class="form-group">
                            								<label class="main-content-label tx-11 tx-medium tx-gray-600">Optional</label> 
                            								<input class="form-control" id="optional1" required="" name="optional2" placeholder="cycle,city etc." type="text">
                            							</div>
                        						    </div>
                        						</div>
                        						<div class="row">
    ...
    function showplan_new()
          {
            ...
            //   	alert(opcodeid);
              	...
              	if(opcodeid ==""){
              	    var opcodeid = $('input[type=radio][name=operator]:checked').attr('id');
              	}
                if($.isNumeric(opcodeid) && prepaid_mobile !== '')
              	{
              		$.ajax({
                  url: '<?php echo base_url(); ?>Retailer/ElectricityInfo',
                  type: 'POST',
                  dataType: 'html',        
                  cache: false,       
