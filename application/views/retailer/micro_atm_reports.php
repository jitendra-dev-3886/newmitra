							     ...
							     <div class="row">
									<div class="col-md-12 col-lg-12 col-xl-12 mx-auto d-block">
    										<div class="card card-body pd-20 pd-md-40 border shadow-none">
    										    <form action="<?php echo site_url('Retailer/search_micro_atm_report'); ?>" method="post">
										   ...
										   <?php $credit_bal=0; if($dmt_txn){foreach($dmt_txn as $res){ ?>
											<tr>
												...
												<td>
												    <?php 
												         $pk=$res->dmt_comm_id;
												         $query = "select * from dmt_commission_slab where dmt_comm_id = '".$pk."'";
												         $data=  $this->db_model->getAllData($query);
												         echo $data[0]->amount;
												    ?>
											    </td>
