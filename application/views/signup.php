			...
			<div class="main-signin-wrapper" style="padding: 0px 20px;">
				...
				<div class="p-5 wd-md-50p" style="width: 35% !important;padding: 15px 3rem !important;">
					<div class="main-signin-header">
						...
						<form action="<?php base_url();?>signupsuccess" method="post">
						    <div class="form-group">
								<label>Name</label><input class="form-control" placeholder="Enter your Name" type="text" name="name" required="required">
							</div>
							<div class="form-group">
								<label>Mobile</label> <input class="form-control" placeholder="Enter your Mobile" type="text" name="mobile" required="required">
							</div>
							<div class="form-group">
								<label>Email</label><input class="form-control" placeholder="Enter your Email" type="text" name="email" required="required">
							</div>
							<div class="form-group">
								<label>Address</label> <input class="form-control" placeholder="Enter your Address" type="text" name="address" required="required">
							</div>
							<div class="form-group">
								<label>Select Package</label> 
								<select name="amount" class="form-control">
								    <option value="99">B2B(Rs.99)</option>
								    <option value="49">B2C(Rs.49)</option>
								    <option value="399">B2B Prime(Rs.399)</option>
								</select>
							</div>
							
							<button class="btn btn-main-primary btn-block" type="submit" name="login">Sign Up</button>
						</form>
					</div>
					<!--<div class="main-signin-footer mt-3 mg-t-5">-->
					<!--	<p><a href="<?php base_url();?>users_login/forget_password">-->
					<!--	    Forgot password?</a></p>-->
					<!--</div>-->
				</div>
			</div>
